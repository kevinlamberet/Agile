...
if (!empty($channel->getElementsByTagName('title')->item(0)->childNodes->item(0)->nodeValue)) {
  $channel_title = $channel->getElementsByTagName('title')->item(0)->childNodes->item(0)->nodeValue;
}

if (!empty($channel->getElementsByTagName('link')->item(0)->childNodes->item(0)->nodeValue)) {
  $channel_link = $channel->getElementsByTagName('link')->item(0)->childNodes->item(0)->nodeValue;
}

if (!empty($channel->getElementsByTagName('description')->item(0)->childNodes->item(0)->nodeValue)) {
